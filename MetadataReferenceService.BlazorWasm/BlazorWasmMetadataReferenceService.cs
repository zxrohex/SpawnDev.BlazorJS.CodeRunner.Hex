...
/// <summary>
/// Represents a single entry if the Javascript value: Blazor.runtime.config.assets[]
/// </summary>
public class BlazorRuntimeConfigAsset
{
    /// <summary>
    /// "Microsoft.AspNetCore.Components.wasm"
    /// "System.Runtime.InteropServices.JavaScript.yzg2xf6fe9.wasm"
    /// </summary>
    public string? Name { get; set; }
    /// <summary>
    /// "https://lostbeard.github.io/SpawnDev.BlazorJS.TransformersJS/_framework/Microsoft.AspNetCore.Components.wasm"
    /// "https://lostbeard.github.io/SharedWebWorkerExample/_framework/System.Runtime.InteropServices.JavaScript.yzg2xf6fe9.wasm"
    /// </summary>
...
public class BlazorWasmMetadataReferenceService : IMetadataReferenceService
{
    ...
    /// </param>
    /// <param name="jsr">
    /// IJSRuntime used to get asset resolved path tp work with .Net 10 asset fingerprinting
    /// </param>
    public BlazorWasmMetadataReferenceService(NavigationManager navigationManager, IJSRuntime jsr)
    {
    ...
    {
        var assets = await JSR.InvokeAsync<BlazorRuntimeConfigAsset[]>("Reflect.get");
    }
